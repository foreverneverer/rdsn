...
typedef struct _disk_info__isset {
  _disk_info__isset() : tag(false), full_dir(false), disk_capacity_mb(false), disk_available_mb(false), holding_primary_replicas(false), holding_secondary_replicas(false), holding_replicas(false) {}
  bool tag :1;
  bool full_dir :1;
...
typedef struct _migrate_replica_request__isset {
  _migrate_replica_request__isset() : node(false), pid(false), origin_disk(false), target_disk(false) {}
  bool node :1;
  bool pid :1;
  bool origin_disk :1;
  bool target_disk :1;
