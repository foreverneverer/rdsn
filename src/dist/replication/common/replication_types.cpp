...
uint32_t duplication_entry::write(::apache::thrift::protocol::TProtocol *oprot) const
{
    ...
    xfer += oprot->writeFieldBegin("progress", ::apache::thrift::protocol::T_MAP, 5);
    {
        ...
        std::map<int32_t, int64_t>::const_iterator _iter515;
        for (_iter515 = this->progress.begin(); _iter515 != this->progress.end(); ++_iter515) {
            xfer += oprot->writeI32(_iter515->first);
            xfer += oprot->writeI64(_iter515->second);
        }
        xfer += oprot->writeMapEnd();
    }
    xfer += oprot->writeFieldEnd();
...
duplication_entry::duplication_entry(const duplication_entry &other516)
{
    dupid = other516.dupid;
    status = other516.status;
    remote = other516.remote;
    create_ts = other516.create_ts;
    progress = other516.progress;
    __isset = other516.__isset;
}
duplication_entry::duplication_entry(duplication_entry &&other517)
{
    dupid = std::move(other517.dupid);
    status = std::move(other517.status);
    remote = std::move(other517.remote);
    create_ts = std::move(other517.create_ts);
    progress = std::move(other517.progress);
    __isset = std::move(other517.__isset);
}
duplication_entry &duplication_entry::operator=(const duplication_entry &other518)
{
...
duplication_entry &duplication_entry::operator=(duplication_entry &&other519)
{
...
duplication_query_request::duplication_query_request(const duplication_query_request &other520)
{
    app_name = other520.app_name;
    __isset = other520.__isset;
}
duplication_query_request::duplication_query_request(duplication_query_request &&other521)
{
    app_name = std::move(other521.app_name);
    __isset = std::move(other521.__isset);
}
duplication_query_request &duplication_query_request::
operator=(const duplication_query_request &other522)
{
...
duplication_query_request &duplication_query_request::
operator=(duplication_query_request &&other523)
{
            ...
            if (ftype == ::apache::thrift::protocol::T_LIST) {
                {
                    ...
                    this->entry_list.resize(_size524);
                    uint32_t _i528;
                    for (_i528 = 0; _i528 < _size524; ++_i528) {
                        xfer += this->entry_list[_i528].read(iprot);
                    }
                    xfer += iprot->readListEnd();
                }
...
uint32_t duplication_query_response::write(::apache::thrift::protocol::TProtocol *oprot) const
{
    ...
    xfer += oprot->writeFieldBegin("entry_list", ::apache::thrift::protocol::T_LIST, 4);
    {
        ...
        std::vector<duplication_entry>::const_iterator _iter529;
        for (_iter529 = this->entry_list.begin(); _iter529 != this->entry_list.end(); ++_iter529) {
...
duplication_query_response::duplication_query_response(const duplication_query_response &other530)
{
    err = other530.err;
    appid = other530.appid;
    entry_list = other530.entry_list;
    __isset = other530.__isset;
}
duplication_query_response::duplication_query_response(duplication_query_response &&other531)
{
    err = std::move(other531.err);
    appid = std::move(other531.appid);
    entry_list = std::move(other531.entry_list);
    __isset = std::move(other531.__isset);
}
duplication_query_response &duplication_query_response::
operator=(const duplication_query_response &other532)
{
    err = other532.err;
...
duplication_query_response &duplication_query_response::
operator=(duplication_query_response &&other533)
{
...
duplication_confirm_entry::duplication_confirm_entry(const duplication_confirm_entry &other534)
{
    dupid = other534.dupid;
    confirmed_decree = other534.confirmed_decree;
    __isset = other534.__isset;
}
duplication_confirm_entry::duplication_confirm_entry(duplication_confirm_entry &&other535)
{
    dupid = std::move(other535.dupid);
    confirmed_decree = std::move(other535.confirmed_decree);
    __isset = std::move(other535.__isset);
}
duplication_confirm_entry &duplication_confirm_entry::
operator=(const duplication_confirm_entry &other536)
{
...
duplication_confirm_entry &duplication_confirm_entry::
operator=(duplication_confirm_entry &&other537)
{
            ...
            if (ftype == ::apache::thrift::protocol::T_MAP) {
                {
                    ...
                    for (_i542 = 0; _i542 < _size538; ++_i542) {
                        ::dsn::gpid _key543;
                        xfer += _key543.read(iprot);
                        std::vector<duplication_confirm_entry> &_val544 =
                            this->confirm_list[_key543];
                        {
                            _val544.clear();
                            uint32_t _size545;
                            ::apache::thrift::protocol::TType _etype548;
                            xfer += iprot->readListBegin(_etype548, _size545);
                            _val544.resize(_size545);
                            uint32_t _i549;
                            for (_i549 = 0; _i549 < _size545; ++_i549) {
                                xfer += _val544[_i549].read(iprot);
                            }
                            xfer += iprot->readListEnd();
                        }
                    }
...
uint32_t duplication_sync_request::write(::apache::thrift::protocol::TProtocol *oprot) const
{
    ...
    xfer += oprot->writeFieldBegin("confirm_list", ::apache::thrift::protocol::T_MAP, 2);
    {
        ...
        std::map<::dsn::gpid, std::vector<duplication_confirm_entry>>::const_iterator _iter550;
        for (_iter550 = this->confirm_list.begin(); _iter550 != this->confirm_list.end();
             ++_iter550) {
            xfer += _iter550->first.write(oprot);
            {
                xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT,
                                              static_cast<uint32_t>(_iter550->second.size()));
                std::vector<duplication_confirm_entry>::const_iterator _iter551;
                for (_iter551 = _iter550->second.begin(); _iter551 != _iter550->second.end();
                     ++_iter551) {
...
duplication_sync_request::duplication_sync_request(const duplication_sync_request &other552)
{
    node = other552.node;
    confirm_list = other552.confirm_list;
    __isset = other552.__isset;
}
duplication_sync_request::duplication_sync_request(duplication_sync_request &&other553)
{
    node = std::move(other553.node);
    confirm_list = std::move(other553.confirm_list);
    __isset = std::move(other553.__isset);
}
duplication_sync_request &duplication_sync_request::
operator=(const duplication_sync_request &other554)
{
    node = other554.node;
...
duplication_sync_request &duplication_sync_request::operator=(duplication_sync_request &&other555)
{
            ...
            if (ftype == ::apache::thrift::protocol::T_MAP) {
                {
                    ...
                    for (_i560 = 0; _i560 < _size556; ++_i560) {
                        int32_t _key561;
                        xfer += iprot->readI32(_key561);
                        std::map<int32_t, duplication_entry> &_val562 = this->dup_map[_key561];
                        {
                            _val562.clear();
                            uint32_t _size563;
                            ...
                            for (_i567 = 0; _i567 < _size563; ++_i567) {
                                int32_t _key568;
                                xfer += iprot->readI32(_key568);
                                duplication_entry &_val569 = _val562[_key568];
                                xfer += _val569.read(iprot);
                            }
                            xfer += iprot->readMapEnd();
                        }
                    }
...
uint32_t duplication_sync_response::write(::apache::thrift::protocol::TProtocol *oprot) const
{
    ...
    xfer += oprot->writeFieldBegin("dup_map", ::apache::thrift::protocol::T_MAP, 2);
    {
        ...
        std::map<int32_t, std::map<int32_t, duplication_entry>>::const_iterator _iter570;
        for (_iter570 = this->dup_map.begin(); _iter570 != this->dup_map.end(); ++_iter570) {
            xfer += oprot->writeI32(_iter570->first);
            {
                xfer += oprot->writeMapBegin(::apache::thrift::protocol::T_I32,
                                             ::apache::thrift::protocol::T_STRUCT,
                                             static_cast<uint32_t>(_iter570->second.size()));
                std::map<int32_t, duplication_entry>::const_iterator _iter571;
                for (_iter571 = _iter570->second.begin(); _iter571 != _iter570->second.end();
                     ++_iter571) {
                    xfer += oprot->writeI32(_iter571->first);
...
duplication_sync_response::duplication_sync_response(const duplication_sync_response &other572)
{
    err = other572.err;
    dup_map = other572.dup_map;
    __isset = other572.__isset;
}
duplication_sync_response::duplication_sync_response(duplication_sync_response &&other573)
{
    err = std::move(other573.err);
    dup_map = std::move(other573.dup_map);
    __isset = std::move(other573.__isset);
}
duplication_sync_response &duplication_sync_response::
operator=(const duplication_sync_response &other574)
{
    err = other574.err;
...
duplication_sync_response &duplication_sync_response::
operator=(duplication_sync_response &&other575)
{
...
ddd_diagnose_request::ddd_diagnose_request(const ddd_diagnose_request &other576)
{
    pid = other576.pid;
    __isset = other576.__isset;
}
ddd_diagnose_request::ddd_diagnose_request(ddd_diagnose_request &&other577)
{
    pid = std::move(other577.pid);
    __isset = std::move(other577.__isset);
}
ddd_diagnose_request &ddd_diagnose_request::operator=(const ddd_diagnose_request &other578)
{
    pid = other578.pid;
    __isset = other578.__isset;
    return *this;
}
ddd_diagnose_request &ddd_diagnose_request::operator=(ddd_diagnose_request &&other579)
{
...
ddd_node_info::ddd_node_info(const ddd_node_info &other580)
{
    node = other580.node;
    drop_time_ms = other580.drop_time_ms;
    is_alive = other580.is_alive;
    is_collected = other580.is_collected;
    ballot = other580.ballot;
    last_committed_decree = other580.last_committed_decree;
    last_prepared_decree = other580.last_prepared_decree;
    __isset = other580.__isset;
}
ddd_node_info::ddd_node_info(ddd_node_info &&other581)
{
    node = std::move(other581.node);
    drop_time_ms = std::move(other581.drop_time_ms);
    is_alive = std::move(other581.is_alive);
    is_collected = std::move(other581.is_collected);
    ballot = std::move(other581.ballot);
    last_committed_decree = std::move(other581.last_committed_decree);
    last_prepared_decree = std::move(other581.last_prepared_decree);
    __isset = std::move(other581.__isset);
}
ddd_node_info &ddd_node_info::operator=(const ddd_node_info &other582)
{
    node = other582.node;
...
ddd_node_info &ddd_node_info::operator=(ddd_node_info &&other583)
{
            ...
            if (ftype == ::apache::thrift::protocol::T_LIST) {
                {
                    ...
                    this->dropped.resize(_size584);
                    uint32_t _i588;
                    for (_i588 = 0; _i588 < _size584; ++_i588) {
                        xfer += this->dropped[_i588].read(iprot);
                    }
                    xfer += iprot->readListEnd();
                }
...
uint32_t ddd_partition_info::write(::apache::thrift::protocol::TProtocol *oprot) const
{
    ...
    xfer += oprot->writeFieldBegin("dropped", ::apache::thrift::protocol::T_LIST, 2);
    {
        ...
        std::vector<ddd_node_info>::const_iterator _iter589;
        for (_iter589 = this->dropped.begin(); _iter589 != this->dropped.end(); ++_iter589) {
...
ddd_partition_info::ddd_partition_info(const ddd_partition_info &other590)
{
    config = other590.config;
    dropped = other590.dropped;
    reason = other590.reason;
    __isset = other590.__isset;
}
ddd_partition_info::ddd_partition_info(ddd_partition_info &&other591)
{
    config = std::move(other591.config);
    dropped = std::move(other591.dropped);
    reason = std::move(other591.reason);
    __isset = std::move(other591.__isset);
}
ddd_partition_info &ddd_partition_info::operator=(const ddd_partition_info &other592)
{
...
ddd_partition_info &ddd_partition_info::operator=(ddd_partition_info &&other593)
{
            ...
            if (ftype == ::apache::thrift::protocol::T_LIST) {
                {
                    ...
                    this->partitions.resize(_size594);
                    uint32_t _i598;
                    for (_i598 = 0; _i598 < _size594; ++_i598) {
                        xfer += this->partitions[_i598].read(iprot);
                    }
                    xfer += iprot->readListEnd();
                }
                this->__isset.partitions = true;
...
uint32_t ddd_diagnose_response::write(::apache::thrift::protocol::TProtocol *oprot) const
{
    ...
    xfer += oprot->writeFieldBegin("partitions", ::apache::thrift::protocol::T_LIST, 2);
    {
        xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT,
                                      static_cast<uint32_t>(this->partitions.size()));
        std::vector<ddd_partition_info>::const_iterator _iter599;
        for (_iter599 = this->partitions.begin(); _iter599 != this->partitions.end(); ++_iter599) {
...
ddd_diagnose_response::ddd_diagnose_response(const ddd_diagnose_response &other600)
{
    err = other600.err;
    partitions = other600.partitions;
    __isset = other600.__isset;
}
ddd_diagnose_response::ddd_diagnose_response(ddd_diagnose_response &&other601)
{
    err = std::move(other601.err);
    partitions = std::move(other601.partitions);
    __isset = std::move(other601.__isset);
}
ddd_diagnose_response &ddd_diagnose_response::operator=(const ddd_diagnose_response &other602)
{
    err = other602.err;
...
ddd_diagnose_response &ddd_diagnose_response::operator=(ddd_diagnose_response &&other603)
{
...
app_partition_split_request::app_partition_split_request(
    const app_partition_split_request &other604)
{
    app_name = other604.app_name;
    new_partition_count = other604.new_partition_count;
    __isset = other604.__isset;
}
app_partition_split_request::app_partition_split_request(app_partition_split_request &&other605)
{
    app_name = std::move(other605.app_name);
    new_partition_count = std::move(other605.new_partition_count);
    __isset = std::move(other605.__isset);
}
app_partition_split_request &app_partition_split_request::
operator=(const app_partition_split_request &other606)
{
...
app_partition_split_request &app_partition_split_request::
operator=(app_partition_split_request &&other607)
{
...
app_partition_split_response::app_partition_split_response(
    const app_partition_split_response &other608)
{
    err = other608.err;
    app_id = other608.app_id;
    partition_count = other608.partition_count;
    __isset = other608.__isset;
}
app_partition_split_response::app_partition_split_response(app_partition_split_response &&other609)
{
    err = std::move(other609.err);
    app_id = std::move(other609.app_id);
    partition_count = std::move(other609.partition_count);
    __isset = std::move(other609.__isset);
}
app_partition_split_response &app_partition_split_response::
operator=(const app_partition_split_response &other610)
{
    err = other610.err;
...
app_partition_split_response &app_partition_split_response::
operator=(app_partition_split_response &&other611)
{
