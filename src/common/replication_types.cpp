...
int _kdisk_replica_migration_statusValues[] = {
...
const std::map<int, const char*> _disk_replica_migration_status_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(4, _kdisk_replica_migration_statusValues, _kdisk_replica_migration_statusNames), ::apache::thrift::TEnumIterator(-1, NULL, NULL));
...
uint32_t disk_info::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("holding_primary_replicas", ::apache::thrift::protocol::T_MAP, 5);
  {
    ...
    for (_iter314 = this->holding_primary_replicas.begin(); _iter314 != this->holding_primary_replicas.end(); ++_iter314)
    {
      xfer += oprot->writeI32(_iter314->first);
      {
        xfer += oprot->writeSetBegin(::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>(_iter314->second.size()));
        std::set< ::dsn::gpid> ::const_iterator _iter315;
        for (_iter315 = _iter314->second.begin(); _iter315 != _iter314->second.end(); ++_iter315)
        {
  ...
  xfer += oprot->writeFieldBegin("holding_secondary_replicas", ::apache::thrift::protocol::T_MAP, 6);
  {
    ...
    for (_iter316 = this->holding_secondary_replicas.begin(); _iter316 != this->holding_secondary_replicas.end(); ++_iter316)
    {
      xfer += oprot->writeI32(_iter316->first);
      {
        xfer += oprot->writeSetBegin(::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>(_iter316->second.size()));
  ...
  {
    xfer += oprot->writeMapBegin(::apache::thrift::protocol::T_I32, ::apache::thrift::protocol::T_SET, static_cast<uint32_t>(this->holding_replicas.size()));
    std::map<int32_t, std::set< ::dsn::gpid> > ::const_iterator _iter318;
    for (_iter318 = this->holding_replicas.begin(); _iter318 != this->holding_replicas.end(); ++_iter318)
    {
      xfer += oprot->writeI32(_iter318->first);
      {
        xfer += oprot->writeSetBegin(::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>(_iter318->second.size()));
        std::set< ::dsn::gpid> ::const_iterator _iter319;
        for (_iter319 = _iter318->second.begin(); _iter319 != _iter318->second.end(); ++_iter319)
        {
...
void disk_info::printTo(std::ostream& out) const {
  ...
  out << ", " << "holding_replicas=" << to_string(holding_replicas);
  out << ")";
}
...
query_disk_info_response& query_disk_info_response::operator=(const query_disk_info_response& other336) {
  err = other336.err;
...
void migrate_replica_request::__set_node(const  ::dsn::rpc_address& val) {
  this->node = val;
}

void migrate_replica_request::__set_pid(const  ::dsn::gpid& val) {
  this->pid = val;
}

void migrate_replica_request::__set_origin_disk(const std::string& val) {
  this->origin_disk = val;
}

void migrate_replica_request::__set_target_disk(const std::string& val) {
...
migrate_replica_request::migrate_replica_request(const migrate_replica_request& other338) {
  node = other338.node;
  pid = other338.pid;
  origin_disk = other338.origin_disk;
  target_disk = other338.target_disk;
  __isset = other338.__isset;
}
migrate_replica_request::migrate_replica_request( migrate_replica_request&& other339) {
  node = std::move(other339.node);
  pid = std::move(other339.pid);
  origin_disk = std::move(other339.origin_disk);
  target_disk = std::move(other339.target_disk);
  __isset = std::move(other339.__isset);
}
migrate_replica_request& migrate_replica_request::operator=(const migrate_replica_request& other340) {
  node = other340.node;
  pid = other340.pid;
  origin_disk = other340.origin_disk;
  target_disk = other340.target_disk;
  __isset = other340.__isset;
  return *this;
}
migrate_replica_request& migrate_replica_request::operator=(migrate_replica_request&& other341) {
  node = std::move(other341.node);
  pid = std::move(other341.pid);
  origin_disk = std::move(other341.origin_disk);
  target_disk = std::move(other341.target_disk);
...
void migrate_replica_response::__set_err(const  ::dsn::error_code& val) {
  this->err = val;
}
...
migrate_replica_response::migrate_replica_response(const migrate_replica_response& other342) {
  err = other342.err;
  __isset = other342.__isset;
}
migrate_replica_response::migrate_replica_response( migrate_replica_response&& other343) {
  err = std::move(other343.err);
  __isset = std::move(other343.__isset);
}
migrate_replica_response& migrate_replica_response::operator=(const migrate_replica_response& other344) {
  err = other344.err;
  __isset = other344.__isset;
  return *this;
}
migrate_replica_response& migrate_replica_response::operator=(migrate_replica_response&& other345) {
...
query_app_info_request::query_app_info_request(const query_app_info_request& other346) {
  meta_server = other346.meta_server;
  __isset = other346.__isset;
}
query_app_info_request::query_app_info_request( query_app_info_request&& other347) {
  meta_server = std::move(other347.meta_server);
  __isset = std::move(other347.__isset);
}
query_app_info_request& query_app_info_request::operator=(const query_app_info_request& other348) {
  meta_server = other348.meta_server;
  __isset = other348.__isset;
  return *this;
}
query_app_info_request& query_app_info_request::operator=(query_app_info_request&& other349) {
  meta_server = std::move(other349.meta_server);
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->apps.resize(_size350);
            uint32_t _i354;
            for (_i354 = 0; _i354 < _size350; ++_i354)
            {
              xfer += this->apps[_i354].read(iprot);
            }
            xfer += iprot->readListEnd();
          }
...
uint32_t query_app_info_response::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("apps", ::apache::thrift::protocol::T_LIST, 2);
  {
    ...
    std::vector< ::dsn::app_info> ::const_iterator _iter355;
    for (_iter355 = this->apps.begin(); _iter355 != this->apps.end(); ++_iter355)
    {
...
query_app_info_response::query_app_info_response(const query_app_info_response& other356) {
  err = other356.err;
  apps = other356.apps;
  __isset = other356.__isset;
}
query_app_info_response::query_app_info_response( query_app_info_response&& other357) {
  err = std::move(other357.err);
  apps = std::move(other357.apps);
  __isset = std::move(other357.__isset);
}
query_app_info_response& query_app_info_response::operator=(const query_app_info_response& other358) {
  err = other358.err;
  apps = other358.apps;
  __isset = other358.__isset;
  return *this;
}
query_app_info_response& query_app_info_response::operator=(query_app_info_response&& other359) {
  err = std::move(other359.err);
  apps = std::move(other359.apps);
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->recovery_set.resize(_size360);
            uint32_t _i364;
            for (_i364 = 0; _i364 < _size360; ++_i364)
            {
              xfer += this->recovery_set[_i364].read(iprot);
            }
            xfer += iprot->readListEnd();
          }
...
uint32_t configuration_recovery_request::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("recovery_set", ::apache::thrift::protocol::T_LIST, 1);
  {
    ...
    std::vector< ::dsn::rpc_address> ::const_iterator _iter365;
    for (_iter365 = this->recovery_set.begin(); _iter365 != this->recovery_set.end(); ++_iter365)
    {
...
configuration_recovery_request::configuration_recovery_request(const configuration_recovery_request& other366) {
  recovery_set = other366.recovery_set;
  skip_bad_nodes = other366.skip_bad_nodes;
  skip_lost_partitions = other366.skip_lost_partitions;
  __isset = other366.__isset;
}
configuration_recovery_request::configuration_recovery_request( configuration_recovery_request&& other367) {
  recovery_set = std::move(other367.recovery_set);
  skip_bad_nodes = std::move(other367.skip_bad_nodes);
  skip_lost_partitions = std::move(other367.skip_lost_partitions);
  __isset = std::move(other367.__isset);
}
configuration_recovery_request& configuration_recovery_request::operator=(const configuration_recovery_request& other368) {
  recovery_set = other368.recovery_set;
  skip_bad_nodes = other368.skip_bad_nodes;
  skip_lost_partitions = other368.skip_lost_partitions;
  __isset = other368.__isset;
  return *this;
}
configuration_recovery_request& configuration_recovery_request::operator=(configuration_recovery_request&& other369) {
  recovery_set = std::move(other369.recovery_set);
  skip_bad_nodes = std::move(other369.skip_bad_nodes);
  skip_lost_partitions = std::move(other369.skip_lost_partitions);
...
configuration_recovery_response::configuration_recovery_response(const configuration_recovery_response& other370) {
  err = other370.err;
  hint_message = other370.hint_message;
  __isset = other370.__isset;
}
configuration_recovery_response::configuration_recovery_response( configuration_recovery_response&& other371) {
  err = std::move(other371.err);
  hint_message = std::move(other371.hint_message);
  __isset = std::move(other371.__isset);
}
configuration_recovery_response& configuration_recovery_response::operator=(const configuration_recovery_response& other372) {
  err = other372.err;
  hint_message = other372.hint_message;
  __isset = other372.__isset;
  return *this;
}
configuration_recovery_response& configuration_recovery_response::operator=(configuration_recovery_response&& other373) {
  err = std::move(other373.err);
  hint_message = std::move(other373.hint_message);
...
policy_info::policy_info(const policy_info& other374) {
  policy_name = other374.policy_name;
  backup_provider_type = other374.backup_provider_type;
  __isset = other374.__isset;
}
policy_info::policy_info( policy_info&& other375) {
  policy_name = std::move(other375.policy_name);
  backup_provider_type = std::move(other375.backup_provider_type);
  __isset = std::move(other375.__isset);
}
policy_info& policy_info::operator=(const policy_info& other376) {
  policy_name = other376.policy_name;
  backup_provider_type = other376.backup_provider_type;
  __isset = other376.__isset;
  return *this;
}
policy_info& policy_info::operator=(policy_info&& other377) {
  policy_name = std::move(other377.policy_name);
  backup_provider_type = std::move(other377.backup_provider_type);
...
configuration_restore_request::configuration_restore_request(const configuration_restore_request& other378) {
  cluster_name = other378.cluster_name;
  policy_name = other378.policy_name;
  time_stamp = other378.time_stamp;
  app_name = other378.app_name;
  app_id = other378.app_id;
  new_app_name = other378.new_app_name;
  backup_provider_name = other378.backup_provider_name;
  skip_bad_partition = other378.skip_bad_partition;
  __isset = other378.__isset;
}
configuration_restore_request::configuration_restore_request( configuration_restore_request&& other379) {
  cluster_name = std::move(other379.cluster_name);
  policy_name = std::move(other379.policy_name);
  time_stamp = std::move(other379.time_stamp);
  app_name = std::move(other379.app_name);
  app_id = std::move(other379.app_id);
  new_app_name = std::move(other379.new_app_name);
  backup_provider_name = std::move(other379.backup_provider_name);
  skip_bad_partition = std::move(other379.skip_bad_partition);
  __isset = std::move(other379.__isset);
}
configuration_restore_request& configuration_restore_request::operator=(const configuration_restore_request& other380) {
  cluster_name = other380.cluster_name;
  policy_name = other380.policy_name;
  time_stamp = other380.time_stamp;
  app_name = other380.app_name;
  app_id = other380.app_id;
  new_app_name = other380.new_app_name;
  backup_provider_name = other380.backup_provider_name;
  skip_bad_partition = other380.skip_bad_partition;
  __isset = other380.__isset;
  return *this;
}
configuration_restore_request& configuration_restore_request::operator=(configuration_restore_request&& other381) {
  cluster_name = std::move(other381.cluster_name);
  policy_name = std::move(other381.policy_name);
  time_stamp = std::move(other381.time_stamp);
  app_name = std::move(other381.app_name);
  app_id = std::move(other381.app_id);
  new_app_name = std::move(other381.new_app_name);
  backup_provider_name = std::move(other381.backup_provider_name);
  skip_bad_partition = std::move(other381.skip_bad_partition);
...
backup_request::backup_request(const backup_request& other382) {
  pid = other382.pid;
  policy = other382.policy;
  app_name = other382.app_name;
  backup_id = other382.backup_id;
  __isset = other382.__isset;
}
backup_request::backup_request( backup_request&& other383) {
  pid = std::move(other383.pid);
  policy = std::move(other383.policy);
  app_name = std::move(other383.app_name);
  backup_id = std::move(other383.backup_id);
  __isset = std::move(other383.__isset);
}
backup_request& backup_request::operator=(const backup_request& other384) {
  pid = other384.pid;
  policy = other384.policy;
  app_name = other384.app_name;
  backup_id = other384.backup_id;
  __isset = other384.__isset;
  return *this;
}
backup_request& backup_request::operator=(backup_request&& other385) {
  pid = std::move(other385.pid);
  policy = std::move(other385.policy);
  app_name = std::move(other385.app_name);
  backup_id = std::move(other385.backup_id);
...
backup_response::backup_response(const backup_response& other386) {
  err = other386.err;
  pid = other386.pid;
  progress = other386.progress;
  policy_name = other386.policy_name;
  backup_id = other386.backup_id;
  checkpoint_total_size = other386.checkpoint_total_size;
  __isset = other386.__isset;
}
backup_response::backup_response( backup_response&& other387) {
  err = std::move(other387.err);
  pid = std::move(other387.pid);
  progress = std::move(other387.progress);
  policy_name = std::move(other387.policy_name);
  backup_id = std::move(other387.backup_id);
  checkpoint_total_size = std::move(other387.checkpoint_total_size);
  __isset = std::move(other387.__isset);
}
backup_response& backup_response::operator=(const backup_response& other388) {
  err = other388.err;
  pid = other388.pid;
  progress = other388.progress;
  policy_name = other388.policy_name;
  backup_id = other388.backup_id;
  checkpoint_total_size = other388.checkpoint_total_size;
  __isset = other388.__isset;
  return *this;
}
backup_response& backup_response::operator=(backup_response&& other389) {
  err = std::move(other389.err);
  pid = std::move(other389.pid);
  progress = std::move(other389.progress);
  policy_name = std::move(other389.policy_name);
  backup_id = std::move(other389.backup_id);
  checkpoint_total_size = std::move(other389.checkpoint_total_size);
...
backup_clear_request::backup_clear_request(const backup_clear_request& other390) {
  pid = other390.pid;
  policy_name = other390.policy_name;
  __isset = other390.__isset;
}
backup_clear_request::backup_clear_request( backup_clear_request&& other391) {
  pid = std::move(other391.pid);
  policy_name = std::move(other391.policy_name);
  __isset = std::move(other391.__isset);
}
backup_clear_request& backup_clear_request::operator=(const backup_clear_request& other392) {
  pid = other392.pid;
  policy_name = other392.policy_name;
  __isset = other392.__isset;
  return *this;
}
backup_clear_request& backup_clear_request::operator=(backup_clear_request&& other393) {
  pid = std::move(other393.pid);
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->add_appids.resize(_size394);
            uint32_t _i398;
            for (_i398 = 0; _i398 < _size394; ++_i398)
            {
              xfer += iprot->readI32(this->add_appids[_i398]);
            }
            xfer += iprot->readListEnd();
          }
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->removal_appids.resize(_size399);
            uint32_t _i403;
            for (_i403 = 0; _i403 < _size399; ++_i403)
            {
              xfer += iprot->readI32(this->removal_appids[_i403]);
            }
            xfer += iprot->readListEnd();
          }
...
uint32_t configuration_modify_backup_policy_request::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.add_appids) {
    xfer += oprot->writeFieldBegin("add_appids", ::apache::thrift::protocol::T_LIST, 2);
    {
      ...
      for (_iter404 = this->add_appids.begin(); _iter404 != this->add_appids.end(); ++_iter404)
      {
  ...
  if (this->__isset.removal_appids) {
    xfer += oprot->writeFieldBegin("removal_appids", ::apache::thrift::protocol::T_LIST, 3);
    {
      ...
      for (_iter405 = this->removal_appids.begin(); _iter405 != this->removal_appids.end(); ++_iter405)
      {
...
configuration_modify_backup_policy_request::configuration_modify_backup_policy_request(const configuration_modify_backup_policy_request& other406) {
  policy_name = other406.policy_name;
  add_appids = other406.add_appids;
  removal_appids = other406.removal_appids;
  new_backup_interval_sec = other406.new_backup_interval_sec;
...
configuration_modify_backup_policy_request::configuration_modify_backup_policy_request( configuration_modify_backup_policy_request&& other407) {
  policy_name = std::move(other407.policy_name);
  add_appids = std::move(other407.add_appids);
  removal_appids = std::move(other407.removal_appids);
  new_backup_interval_sec = std::move(other407.new_backup_interval_sec);
...
configuration_modify_backup_policy_request& configuration_modify_backup_policy_request::operator=(const configuration_modify_backup_policy_request& other408) {
  policy_name = other408.policy_name;
  add_appids = other408.add_appids;
  removal_appids = other408.removal_appids;
  new_backup_interval_sec = other408.new_backup_interval_sec;
...
configuration_modify_backup_policy_request& configuration_modify_backup_policy_request::operator=(configuration_modify_backup_policy_request&& other409) {
  policy_name = std::move(other409.policy_name);
  add_appids = std::move(other409.add_appids);
  removal_appids = std::move(other409.removal_appids);
  new_backup_interval_sec = std::move(other409.new_backup_interval_sec);
...
configuration_modify_backup_policy_response::configuration_modify_backup_policy_response(const configuration_modify_backup_policy_response& other410) {
  err = other410.err;
  hint_message = other410.hint_message;
  __isset = other410.__isset;
}
configuration_modify_backup_policy_response::configuration_modify_backup_policy_response( configuration_modify_backup_policy_response&& other411) {
  err = std::move(other411.err);
  hint_message = std::move(other411.hint_message);
  __isset = std::move(other411.__isset);
}
configuration_modify_backup_policy_response& configuration_modify_backup_policy_response::operator=(const configuration_modify_backup_policy_response& other412) {
  err = other412.err;
  hint_message = other412.hint_message;
  __isset = other412.__isset;
  return *this;
}
configuration_modify_backup_policy_response& configuration_modify_backup_policy_response::operator=(configuration_modify_backup_policy_response&& other413) {
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->app_ids.resize(_size414);
            uint32_t _i418;
            for (_i418 = 0; _i418 < _size414; ++_i418)
            {
              xfer += iprot->readI32(this->app_ids[_i418]);
            }
            xfer += iprot->readListEnd();
          }
...
uint32_t configuration_add_backup_policy_request::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("app_ids", ::apache::thrift::protocol::T_LIST, 3);
  {
    ...
    std::vector<int32_t> ::const_iterator _iter419;
...
configuration_add_backup_policy_request::configuration_add_backup_policy_request(const configuration_add_backup_policy_request& other420) {
...
configuration_add_backup_policy_request::configuration_add_backup_policy_request( configuration_add_backup_policy_request&& other421) {
...
configuration_add_backup_policy_request& configuration_add_backup_policy_request::operator=(const configuration_add_backup_policy_request& other422) {
...
configuration_add_backup_policy_request& configuration_add_backup_policy_request::operator=(configuration_add_backup_policy_request&& other423) {
...
configuration_add_backup_policy_response::configuration_add_backup_policy_response(const configuration_add_backup_policy_response& other424) {
  err = other424.err;
  hint_message = other424.hint_message;
  __isset = other424.__isset;
}
configuration_add_backup_policy_response::configuration_add_backup_policy_response( configuration_add_backup_policy_response&& other425) {
  err = std::move(other425.err);
  hint_message = std::move(other425.hint_message);
  __isset = std::move(other425.__isset);
}
configuration_add_backup_policy_response& configuration_add_backup_policy_response::operator=(const configuration_add_backup_policy_response& other426) {
  err = other426.err;
  hint_message = other426.hint_message;
  __isset = other426.__isset;
  return *this;
}
configuration_add_backup_policy_response& configuration_add_backup_policy_response::operator=(configuration_add_backup_policy_response&& other427) {
  err = std::move(other427.err);
  hint_message = std::move(other427.hint_message);
        ...
        if (ftype == ::apache::thrift::protocol::T_SET) {
          {
            ...
            {
              int32_t _elem433;
              xfer += iprot->readI32(_elem433);
              this->app_ids.insert(_elem433);
            }
            xfer += iprot->readSetEnd();
          }
          this->__isset.app_ids = true;
...
uint32_t policy_entry::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("app_ids", ::apache::thrift::protocol::T_SET, 4);
  {
    ...
    std::set<int32_t> ::const_iterator _iter434;
    for (_iter434 = this->app_ids.begin(); _iter434 != this->app_ids.end(); ++_iter434)
    {
...
policy_entry::policy_entry(const policy_entry& other435) {
  policy_name = other435.policy_name;
  backup_provider_type = other435.backup_provider_type;
  backup_interval_seconds = other435.backup_interval_seconds;
  app_ids = other435.app_ids;
  backup_history_count_to_keep = other435.backup_history_count_to_keep;
  start_time = other435.start_time;
  is_disable = other435.is_disable;
  __isset = other435.__isset;
}
policy_entry::policy_entry( policy_entry&& other436) {
  policy_name = std::move(other436.policy_name);
  backup_provider_type = std::move(other436.backup_provider_type);
  backup_interval_seconds = std::move(other436.backup_interval_seconds);
  app_ids = std::move(other436.app_ids);
  backup_history_count_to_keep = std::move(other436.backup_history_count_to_keep);
  start_time = std::move(other436.start_time);
  is_disable = std::move(other436.is_disable);
  __isset = std::move(other436.__isset);
}
policy_entry& policy_entry::operator=(const policy_entry& other437) {
  policy_name = other437.policy_name;
  backup_provider_type = other437.backup_provider_type;
  backup_interval_seconds = other437.backup_interval_seconds;
  app_ids = other437.app_ids;
  backup_history_count_to_keep = other437.backup_history_count_to_keep;
  start_time = other437.start_time;
  is_disable = other437.is_disable;
  __isset = other437.__isset;
  return *this;
}
policy_entry& policy_entry::operator=(policy_entry&& other438) {
  policy_name = std::move(other438.policy_name);
  backup_provider_type = std::move(other438.backup_provider_type);
  backup_interval_seconds = std::move(other438.backup_interval_seconds);
  app_ids = std::move(other438.app_ids);
  backup_history_count_to_keep = std::move(other438.backup_history_count_to_keep);
  start_time = std::move(other438.start_time);
  is_disable = std::move(other438.is_disable);
        ...
        if (ftype == ::apache::thrift::protocol::T_SET) {
          {
            ...
            xfer += iprot->readSetBegin(_etype442, _size439);
            uint32_t _i443;
            for (_i443 = 0; _i443 < _size439; ++_i443)
            {
              int32_t _elem444;
              xfer += iprot->readI32(_elem444);
              this->app_ids.insert(_elem444);
            }
            xfer += iprot->readSetEnd();
          }
          this->__isset.app_ids = true;
...
uint32_t backup_entry::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  {
    xfer += oprot->writeSetBegin(::apache::thrift::protocol::T_I32, static_cast<uint32_t>(this->app_ids.size()));
    std::set<int32_t> ::const_iterator _iter445;
    for (_iter445 = this->app_ids.begin(); _iter445 != this->app_ids.end(); ++_iter445)
    {
...
backup_entry::backup_entry(const backup_entry& other446) {
  backup_id = other446.backup_id;
  start_time_ms = other446.start_time_ms;
  end_time_ms = other446.end_time_ms;
  app_ids = other446.app_ids;
  __isset = other446.__isset;
}
backup_entry::backup_entry( backup_entry&& other447) {
  backup_id = std::move(other447.backup_id);
  start_time_ms = std::move(other447.start_time_ms);
  end_time_ms = std::move(other447.end_time_ms);
  app_ids = std::move(other447.app_ids);
  __isset = std::move(other447.__isset);
}
backup_entry& backup_entry::operator=(const backup_entry& other448) {
  backup_id = other448.backup_id;
  start_time_ms = other448.start_time_ms;
  end_time_ms = other448.end_time_ms;
  app_ids = other448.app_ids;
  __isset = other448.__isset;
  return *this;
}
backup_entry& backup_entry::operator=(backup_entry&& other449) {
  backup_id = std::move(other449.backup_id);
  start_time_ms = std::move(other449.start_time_ms);
  end_time_ms = std::move(other449.end_time_ms);
  app_ids = std::move(other449.app_ids);
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->policy_names.resize(_size450);
            uint32_t _i454;
            for (_i454 = 0; _i454 < _size450; ++_i454)
            {
              xfer += iprot->readString(this->policy_names[_i454]);
            }
            xfer += iprot->readListEnd();
          }
...
uint32_t configuration_query_backup_policy_request::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("policy_names", ::apache::thrift::protocol::T_LIST, 1);
  {
    ...
    for (_iter455 = this->policy_names.begin(); _iter455 != this->policy_names.end(); ++_iter455)
    {
...
configuration_query_backup_policy_request::configuration_query_backup_policy_request(const configuration_query_backup_policy_request& other456) {
  policy_names = other456.policy_names;
  backup_info_count = other456.backup_info_count;
  __isset = other456.__isset;
}
configuration_query_backup_policy_request::configuration_query_backup_policy_request( configuration_query_backup_policy_request&& other457) {
  policy_names = std::move(other457.policy_names);
  backup_info_count = std::move(other457.backup_info_count);
  __isset = std::move(other457.__isset);
}
configuration_query_backup_policy_request& configuration_query_backup_policy_request::operator=(const configuration_query_backup_policy_request& other458) {
  policy_names = other458.policy_names;
  backup_info_count = other458.backup_info_count;
  __isset = other458.__isset;
  return *this;
}
configuration_query_backup_policy_request& configuration_query_backup_policy_request::operator=(configuration_query_backup_policy_request&& other459) {
  policy_names = std::move(other459.policy_names);
  backup_info_count = std::move(other459.backup_info_count);
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->policys.resize(_size460);
            uint32_t _i464;
            for (_i464 = 0; _i464 < _size460; ++_i464)
            {
              xfer += this->policys[_i464].read(iprot);
            }
            xfer += iprot->readListEnd();
          }
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->backup_infos.resize(_size465);
            uint32_t _i469;
            for (_i469 = 0; _i469 < _size465; ++_i469)
            {
              {
                this->backup_infos[_i469].clear();
                uint32_t _size470;
                ::apache::thrift::protocol::TType _etype473;
                xfer += iprot->readListBegin(_etype473, _size470);
                this->backup_infos[_i469].resize(_size470);
                uint32_t _i474;
                for (_i474 = 0; _i474 < _size470; ++_i474)
                {
                  xfer += this->backup_infos[_i469][_i474].read(iprot);
                }
                xfer += iprot->readListEnd();
              }
            }
...
uint32_t configuration_query_backup_policy_response::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("policys", ::apache::thrift::protocol::T_LIST, 2);
  {
    ...
    std::vector<policy_entry> ::const_iterator _iter475;
    for (_iter475 = this->policys.begin(); _iter475 != this->policys.end(); ++_iter475)
    {
  ...
  xfer += oprot->writeFieldBegin("backup_infos", ::apache::thrift::protocol::T_LIST, 3);
  {
    ...
    std::vector<std::vector<backup_entry> > ::const_iterator _iter476;
    for (_iter476 = this->backup_infos.begin(); _iter476 != this->backup_infos.end(); ++_iter476)
    {
      {
        xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>((*_iter476).size()));
        std::vector<backup_entry> ::const_iterator _iter477;
...
configuration_query_backup_policy_response::configuration_query_backup_policy_response(const configuration_query_backup_policy_response& other478) {
  err = other478.err;
  policys = other478.policys;
  backup_infos = other478.backup_infos;
  hint_msg = other478.hint_msg;
  __isset = other478.__isset;
}
configuration_query_backup_policy_response::configuration_query_backup_policy_response( configuration_query_backup_policy_response&& other479) {
  err = std::move(other479.err);
  policys = std::move(other479.policys);
  backup_infos = std::move(other479.backup_infos);
  hint_msg = std::move(other479.hint_msg);
  __isset = std::move(other479.__isset);
}
configuration_query_backup_policy_response& configuration_query_backup_policy_response::operator=(const configuration_query_backup_policy_response& other480) {
  err = other480.err;
  policys = other480.policys;
  backup_infos = other480.backup_infos;
  hint_msg = other480.hint_msg;
  __isset = other480.__isset;
  return *this;
}
configuration_query_backup_policy_response& configuration_query_backup_policy_response::operator=(configuration_query_backup_policy_response&& other481) {
  err = std::move(other481.err);
  policys = std::move(other481.policys);
  backup_infos = std::move(other481.backup_infos);
  hint_msg = std::move(other481.hint_msg);
...
configuration_report_restore_status_request::configuration_report_restore_status_request(const configuration_report_restore_status_request& other482) {
  pid = other482.pid;
  restore_status = other482.restore_status;
  progress = other482.progress;
  reason = other482.reason;
  __isset = other482.__isset;
}
configuration_report_restore_status_request::configuration_report_restore_status_request( configuration_report_restore_status_request&& other483) {
  pid = std::move(other483.pid);
  restore_status = std::move(other483.restore_status);
  progress = std::move(other483.progress);
  reason = std::move(other483.reason);
  __isset = std::move(other483.__isset);
}
configuration_report_restore_status_request& configuration_report_restore_status_request::operator=(const configuration_report_restore_status_request& other484) {
  pid = other484.pid;
  restore_status = other484.restore_status;
  progress = other484.progress;
  reason = other484.reason;
  __isset = other484.__isset;
  return *this;
}
configuration_report_restore_status_request& configuration_report_restore_status_request::operator=(configuration_report_restore_status_request&& other485) {
  pid = std::move(other485.pid);
  restore_status = std::move(other485.restore_status);
  progress = std::move(other485.progress);
  reason = std::move(other485.reason);
...
configuration_report_restore_status_response::configuration_report_restore_status_response(const configuration_report_restore_status_response& other486) {
  err = other486.err;
  __isset = other486.__isset;
}
configuration_report_restore_status_response::configuration_report_restore_status_response( configuration_report_restore_status_response&& other487) {
  err = std::move(other487.err);
  __isset = std::move(other487.__isset);
}
configuration_report_restore_status_response& configuration_report_restore_status_response::operator=(const configuration_report_restore_status_response& other488) {
  err = other488.err;
  __isset = other488.__isset;
  return *this;
}
configuration_report_restore_status_response& configuration_report_restore_status_response::operator=(configuration_report_restore_status_response&& other489) {
...
configuration_query_restore_request::configuration_query_restore_request(const configuration_query_restore_request& other490) {
  restore_app_id = other490.restore_app_id;
  __isset = other490.__isset;
}
configuration_query_restore_request::configuration_query_restore_request( configuration_query_restore_request&& other491) {
  restore_app_id = std::move(other491.restore_app_id);
  __isset = std::move(other491.__isset);
}
configuration_query_restore_request& configuration_query_restore_request::operator=(const configuration_query_restore_request& other492) {
  restore_app_id = other492.restore_app_id;
  __isset = other492.__isset;
  return *this;
}
configuration_query_restore_request& configuration_query_restore_request::operator=(configuration_query_restore_request&& other493) {
  restore_app_id = std::move(other493.restore_app_id);
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->restore_status.resize(_size494);
            uint32_t _i498;
            for (_i498 = 0; _i498 < _size494; ++_i498)
            {
              xfer += this->restore_status[_i498].read(iprot);
            }
            xfer += iprot->readListEnd();
          }
          this->__isset.restore_status = true;
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->restore_progress.resize(_size499);
            uint32_t _i503;
            for (_i503 = 0; _i503 < _size499; ++_i503)
            {
              xfer += iprot->readI32(this->restore_progress[_i503]);
            }
            xfer += iprot->readListEnd();
          }
...
uint32_t configuration_query_restore_response::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("restore_status", ::apache::thrift::protocol::T_LIST, 2);
  {
    ...
    std::vector< ::dsn::error_code> ::const_iterator _iter504;
    for (_iter504 = this->restore_status.begin(); _iter504 != this->restore_status.end(); ++_iter504)
    {
  ...
  xfer += oprot->writeFieldBegin("restore_progress", ::apache::thrift::protocol::T_LIST, 3);
  {
    ...
    std::vector<int32_t> ::const_iterator _iter505;
    for (_iter505 = this->restore_progress.begin(); _iter505 != this->restore_progress.end(); ++_iter505)
    {
...
configuration_query_restore_response::configuration_query_restore_response(const configuration_query_restore_response& other506) {
  err = other506.err;
  restore_status = other506.restore_status;
  restore_progress = other506.restore_progress;
  __isset = other506.__isset;
}
configuration_query_restore_response::configuration_query_restore_response( configuration_query_restore_response&& other507) {
  err = std::move(other507.err);
  restore_status = std::move(other507.restore_status);
  restore_progress = std::move(other507.restore_progress);
  __isset = std::move(other507.__isset);
}
configuration_query_restore_response& configuration_query_restore_response::operator=(const configuration_query_restore_response& other508) {
  err = other508.err;
  restore_status = other508.restore_status;
  restore_progress = other508.restore_progress;
  __isset = other508.__isset;
  return *this;
}
configuration_query_restore_response& configuration_query_restore_response::operator=(configuration_query_restore_response&& other509) {
  err = std::move(other509.err);
  restore_status = std::move(other509.restore_status);
  restore_progress = std::move(other509.restore_progress);
...
file_meta::file_meta(const file_meta& other510) {
  name = other510.name;
  size = other510.size;
  md5 = other510.md5;
  __isset = other510.__isset;
}
file_meta::file_meta( file_meta&& other511) {
  name = std::move(other511.name);
  size = std::move(other511.size);
  md5 = std::move(other511.md5);
  __isset = std::move(other511.__isset);
}
file_meta& file_meta::operator=(const file_meta& other512) {
  name = other512.name;
  size = other512.size;
  md5 = other512.md5;
...
file_meta& file_meta::operator=(file_meta&& other513) {
  name = std::move(other513.name);
  size = std::move(other513.size);
  md5 = std::move(other513.md5);
    ...
    switch (fid)
    {
      ...
      case 2:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->op = (app_env_operation::type)ecast514;
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->keys.resize(_size515);
            uint32_t _i519;
            for (_i519 = 0; _i519 < _size515; ++_i519)
            {
              xfer += iprot->readString(this->keys[_i519]);
            }
            xfer += iprot->readListEnd();
          }
          this->__isset.keys = true;
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->values.resize(_size520);
            uint32_t _i524;
            for (_i524 = 0; _i524 < _size520; ++_i524)
            {
              xfer += iprot->readString(this->values[_i524]);
            }
            xfer += iprot->readListEnd();
          }
          this->__isset.values = true;
...
uint32_t configuration_update_app_env_request::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.keys) {
    xfer += oprot->writeFieldBegin("keys", ::apache::thrift::protocol::T_LIST, 3);
    {
      ...
      for (_iter525 = this->keys.begin(); _iter525 != this->keys.end(); ++_iter525)
      {
  ...
  if (this->__isset.values) {
    xfer += oprot->writeFieldBegin("values", ::apache::thrift::protocol::T_LIST, 4);
    {
      ...
      for (_iter526 = this->values.begin(); _iter526 != this->values.end(); ++_iter526)
      {
...
configuration_update_app_env_request::configuration_update_app_env_request(const configuration_update_app_env_request& other527) {
  app_name = other527.app_name;
  op = other527.op;
  keys = other527.keys;
  values = other527.values;
  clear_prefix = other527.clear_prefix;
  __isset = other527.__isset;
}
configuration_update_app_env_request::configuration_update_app_env_request( configuration_update_app_env_request&& other528) {
  app_name = std::move(other528.app_name);
  op = std::move(other528.op);
  keys = std::move(other528.keys);
  values = std::move(other528.values);
  clear_prefix = std::move(other528.clear_prefix);
  __isset = std::move(other528.__isset);
}
configuration_update_app_env_request& configuration_update_app_env_request::operator=(const configuration_update_app_env_request& other529) {
  app_name = other529.app_name;
  op = other529.op;
  keys = other529.keys;
  values = other529.values;
  clear_prefix = other529.clear_prefix;
  __isset = other529.__isset;
  return *this;
}
configuration_update_app_env_request& configuration_update_app_env_request::operator=(configuration_update_app_env_request&& other530) {
  app_name = std::move(other530.app_name);
  op = std::move(other530.op);
  keys = std::move(other530.keys);
  values = std::move(other530.values);
  clear_prefix = std::move(other530.clear_prefix);
...
configuration_update_app_env_response::configuration_update_app_env_response(const configuration_update_app_env_response& other531) {
  err = other531.err;
  hint_message = other531.hint_message;
  __isset = other531.__isset;
}
configuration_update_app_env_response::configuration_update_app_env_response( configuration_update_app_env_response&& other532) {
  err = std::move(other532.err);
  hint_message = std::move(other532.hint_message);
  __isset = std::move(other532.__isset);
}
configuration_update_app_env_response& configuration_update_app_env_response::operator=(const configuration_update_app_env_response& other533) {
  err = other533.err;
  hint_message = other533.hint_message;
  __isset = other533.__isset;
  return *this;
}
configuration_update_app_env_response& configuration_update_app_env_response::operator=(configuration_update_app_env_response&& other534) {
  err = std::move(other534.err);
  hint_message = std::move(other534.hint_message);
...
duplication_add_request::duplication_add_request(const duplication_add_request& other535) {
  app_name = other535.app_name;
  remote_cluster_name = other535.remote_cluster_name;
  freezed = other535.freezed;
  __isset = other535.__isset;
}
duplication_add_request::duplication_add_request( duplication_add_request&& other536) {
  app_name = std::move(other536.app_name);
  remote_cluster_name = std::move(other536.remote_cluster_name);
  freezed = std::move(other536.freezed);
  __isset = std::move(other536.__isset);
}
duplication_add_request& duplication_add_request::operator=(const duplication_add_request& other537) {
  app_name = other537.app_name;
  remote_cluster_name = other537.remote_cluster_name;
  freezed = other537.freezed;
  __isset = other537.__isset;
  return *this;
}
duplication_add_request& duplication_add_request::operator=(duplication_add_request&& other538) {
  app_name = std::move(other538.app_name);
  remote_cluster_name = std::move(other538.remote_cluster_name);
  freezed = std::move(other538.freezed);
...
duplication_add_response::duplication_add_response(const duplication_add_response& other539) {
  err = other539.err;
...
duplication_add_response::duplication_add_response( duplication_add_response&& other540) {
  err = std::move(other540.err);
  appid = std::move(other540.appid);
  dupid = std::move(other540.dupid);
  hint = std::move(other540.hint);
  __isset = std::move(other540.__isset);
}
duplication_add_response& duplication_add_response::operator=(const duplication_add_response& other541) {
  err = other541.err;
...
duplication_add_response& duplication_add_response::operator=(duplication_add_response&& other542) {
  err = std::move(other542.err);
  appid = std::move(other542.appid);
  dupid = std::move(other542.dupid);
  hint = std::move(other542.hint);
    ...
    switch (fid)
    {
      ...
      case 3:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->status = (duplication_status::type)ecast543;
          this->__isset.status = true;
        } else {
          xfer += iprot->skip(ftype);
        }
      ...
      case 4:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->fail_mode = (duplication_fail_mode::type)ecast544;
...
duplication_modify_request::duplication_modify_request(const duplication_modify_request& other545) {
  app_name = other545.app_name;
  dupid = other545.dupid;
  status = other545.status;
  fail_mode = other545.fail_mode;
  __isset = other545.__isset;
}
duplication_modify_request::duplication_modify_request( duplication_modify_request&& other546) {
  app_name = std::move(other546.app_name);
  dupid = std::move(other546.dupid);
  status = std::move(other546.status);
  fail_mode = std::move(other546.fail_mode);
  __isset = std::move(other546.__isset);
}
duplication_modify_request& duplication_modify_request::operator=(const duplication_modify_request& other547) {
  app_name = other547.app_name;
  dupid = other547.dupid;
  status = other547.status;
  fail_mode = other547.fail_mode;
  __isset = other547.__isset;
  return *this;
}
duplication_modify_request& duplication_modify_request::operator=(duplication_modify_request&& other548) {
  app_name = std::move(other548.app_name);
  dupid = std::move(other548.dupid);
  status = std::move(other548.status);
  fail_mode = std::move(other548.fail_mode);
...
duplication_modify_response::duplication_modify_response(const duplication_modify_response& other549) {
  err = other549.err;
  appid = other549.appid;
  __isset = other549.__isset;
}
duplication_modify_response::duplication_modify_response( duplication_modify_response&& other550) {
  err = std::move(other550.err);
  appid = std::move(other550.appid);
  __isset = std::move(other550.__isset);
}
duplication_modify_response& duplication_modify_response::operator=(const duplication_modify_response& other551) {
  err = other551.err;
  appid = other551.appid;
  __isset = other551.__isset;
  return *this;
}
duplication_modify_response& duplication_modify_response::operator=(duplication_modify_response&& other552) {
    ...
    switch (fid)
    {
      ...
      case 2:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->status = (duplication_status::type)ecast553;
          this->__isset.status = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        ...
        if (ftype == ::apache::thrift::protocol::T_MAP) {
          {
            ...
            {
              int32_t _key559;
              xfer += iprot->readI32(_key559);
              int64_t& _val560 = this->progress[_key559];
              xfer += iprot->readI64(_val560);
            }
            xfer += iprot->readMapEnd();
          }
          this->__isset.progress = true;
      ...
      case 7:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->fail_mode = (duplication_fail_mode::type)ecast561;
          this->__isset.fail_mode = true;
        } else {
          xfer += iprot->skip(ftype);
        }
...
uint32_t duplication_entry::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.progress) {
    xfer += oprot->writeFieldBegin("progress", ::apache::thrift::protocol::T_MAP, 5);
    {
      ...
      std::map<int32_t, int64_t> ::const_iterator _iter562;
      for (_iter562 = this->progress.begin(); _iter562 != this->progress.end(); ++_iter562)
      {
        xfer += oprot->writeI32(_iter562->first);
        xfer += oprot->writeI64(_iter562->second);
      }
      xfer += oprot->writeMapEnd();
    }
    xfer += oprot->writeFieldEnd();
...
duplication_entry::duplication_entry(const duplication_entry& other563) {
  dupid = other563.dupid;
  status = other563.status;
  remote = other563.remote;
  create_ts = other563.create_ts;
  progress = other563.progress;
  fail_mode = other563.fail_mode;
  __isset = other563.__isset;
}
duplication_entry::duplication_entry( duplication_entry&& other564) {
  dupid = std::move(other564.dupid);
  status = std::move(other564.status);
  remote = std::move(other564.remote);
  create_ts = std::move(other564.create_ts);
  progress = std::move(other564.progress);
  fail_mode = std::move(other564.fail_mode);
  __isset = std::move(other564.__isset);
}
duplication_entry& duplication_entry::operator=(const duplication_entry& other565) {
  dupid = other565.dupid;
  status = other565.status;
  remote = other565.remote;
  create_ts = other565.create_ts;
  progress = other565.progress;
  fail_mode = other565.fail_mode;
  __isset = other565.__isset;
  return *this;
}
duplication_entry& duplication_entry::operator=(duplication_entry&& other566) {
  dupid = std::move(other566.dupid);
  status = std::move(other566.status);
  remote = std::move(other566.remote);
  create_ts = std::move(other566.create_ts);
  progress = std::move(other566.progress);
  fail_mode = std::move(other566.fail_mode);
...
duplication_query_request::duplication_query_request(const duplication_query_request& other567) {
  app_name = other567.app_name;
  __isset = other567.__isset;
}
duplication_query_request::duplication_query_request( duplication_query_request&& other568) {
  app_name = std::move(other568.app_name);
  __isset = std::move(other568.__isset);
}
duplication_query_request& duplication_query_request::operator=(const duplication_query_request& other569) {
  app_name = other569.app_name;
  __isset = other569.__isset;
  return *this;
}
duplication_query_request& duplication_query_request::operator=(duplication_query_request&& other570) {
  app_name = std::move(other570.app_name);
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->entry_list.resize(_size571);
            uint32_t _i575;
            for (_i575 = 0; _i575 < _size571; ++_i575)
            {
              xfer += this->entry_list[_i575].read(iprot);
            }
            xfer += iprot->readListEnd();
          }
...
uint32_t duplication_query_response::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("entry_list", ::apache::thrift::protocol::T_LIST, 4);
  {
    ...
    std::vector<duplication_entry> ::const_iterator _iter576;
    for (_iter576 = this->entry_list.begin(); _iter576 != this->entry_list.end(); ++_iter576)
    {
...
duplication_query_response::duplication_query_response(const duplication_query_response& other577) {
  err = other577.err;
  appid = other577.appid;
  entry_list = other577.entry_list;
  __isset = other577.__isset;
}
duplication_query_response::duplication_query_response( duplication_query_response&& other578) {
  err = std::move(other578.err);
  appid = std::move(other578.appid);
  entry_list = std::move(other578.entry_list);
  __isset = std::move(other578.__isset);
}
duplication_query_response& duplication_query_response::operator=(const duplication_query_response& other579) {
  err = other579.err;
  appid = other579.appid;
  entry_list = other579.entry_list;
  __isset = other579.__isset;
  return *this;
}
duplication_query_response& duplication_query_response::operator=(duplication_query_response&& other580) {
  err = std::move(other580.err);
  appid = std::move(other580.appid);
  entry_list = std::move(other580.entry_list);
...
duplication_confirm_entry::duplication_confirm_entry(const duplication_confirm_entry& other581) {
  dupid = other581.dupid;
  confirmed_decree = other581.confirmed_decree;
  __isset = other581.__isset;
}
duplication_confirm_entry::duplication_confirm_entry( duplication_confirm_entry&& other582) {
  dupid = std::move(other582.dupid);
  confirmed_decree = std::move(other582.confirmed_decree);
  __isset = std::move(other582.__isset);
}
duplication_confirm_entry& duplication_confirm_entry::operator=(const duplication_confirm_entry& other583) {
  dupid = other583.dupid;
  confirmed_decree = other583.confirmed_decree;
  __isset = other583.__isset;
  return *this;
}
duplication_confirm_entry& duplication_confirm_entry::operator=(duplication_confirm_entry&& other584) {
  dupid = std::move(other584.dupid);
  confirmed_decree = std::move(other584.confirmed_decree);
        ...
        if (ftype == ::apache::thrift::protocol::T_MAP) {
          {
            ...
            {
               ::dsn::gpid _key590;
              xfer += _key590.read(iprot);
              std::vector<duplication_confirm_entry> & _val591 = this->confirm_list[_key590];
              {
                _val591.clear();
                uint32_t _size592;
...
uint32_t duplication_sync_request::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("confirm_list", ::apache::thrift::protocol::T_MAP, 2);
  {
    ...
    std::map< ::dsn::gpid, std::vector<duplication_confirm_entry> > ::const_iterator _iter597;
    for (_iter597 = this->confirm_list.begin(); _iter597 != this->confirm_list.end(); ++_iter597)
    {
      xfer += _iter597->first.write(oprot);
      {
        xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>(_iter597->second.size()));
        std::vector<duplication_confirm_entry> ::const_iterator _iter598;
...
duplication_sync_request::duplication_sync_request(const duplication_sync_request& other599) {
  node = other599.node;
  confirm_list = other599.confirm_list;
  __isset = other599.__isset;
}
duplication_sync_request::duplication_sync_request( duplication_sync_request&& other600) {
  node = std::move(other600.node);
  confirm_list = std::move(other600.confirm_list);
  __isset = std::move(other600.__isset);
}
duplication_sync_request& duplication_sync_request::operator=(const duplication_sync_request& other601) {
  node = other601.node;
  confirm_list = other601.confirm_list;
  __isset = other601.__isset;
  return *this;
}
duplication_sync_request& duplication_sync_request::operator=(duplication_sync_request&& other602) {
  node = std::move(other602.node);
  confirm_list = std::move(other602.confirm_list);
        ...
        if (ftype == ::apache::thrift::protocol::T_MAP) {
          {
            ...
            {
              int32_t _key608;
              xfer += iprot->readI32(_key608);
              std::map<int32_t, duplication_entry> & _val609 = this->dup_map[_key608];
              {
                _val609.clear();
                uint32_t _size610;
                ...
                {
                  int32_t _key615;
                  xfer += iprot->readI32(_key615);
                  duplication_entry& _val616 = _val609[_key615];
...
uint32_t duplication_sync_response::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("dup_map", ::apache::thrift::protocol::T_MAP, 2);
  {
    ...
    std::map<int32_t, std::map<int32_t, duplication_entry> > ::const_iterator _iter617;
    for (_iter617 = this->dup_map.begin(); _iter617 != this->dup_map.end(); ++_iter617)
    {
      xfer += oprot->writeI32(_iter617->first);
      {
        xfer += oprot->writeMapBegin(::apache::thrift::protocol::T_I32, ::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>(_iter617->second.size()));
        std::map<int32_t, duplication_entry> ::const_iterator _iter618;
        for (_iter618 = _iter617->second.begin(); _iter618 != _iter617->second.end(); ++_iter618)
        {
...
duplication_sync_response::duplication_sync_response(const duplication_sync_response& other619) {
  err = other619.err;
  dup_map = other619.dup_map;
  __isset = other619.__isset;
}
duplication_sync_response::duplication_sync_response( duplication_sync_response&& other620) {
  err = std::move(other620.err);
  dup_map = std::move(other620.dup_map);
  __isset = std::move(other620.__isset);
}
duplication_sync_response& duplication_sync_response::operator=(const duplication_sync_response& other621) {
  err = other621.err;
  dup_map = other621.dup_map;
  __isset = other621.__isset;
  return *this;
}
duplication_sync_response& duplication_sync_response::operator=(duplication_sync_response&& other622) {
  err = std::move(other622.err);
  dup_map = std::move(other622.dup_map);
...
ddd_diagnose_request::ddd_diagnose_request(const ddd_diagnose_request& other623) {
  pid = other623.pid;
  __isset = other623.__isset;
}
ddd_diagnose_request::ddd_diagnose_request( ddd_diagnose_request&& other624) {
  pid = std::move(other624.pid);
  __isset = std::move(other624.__isset);
}
ddd_diagnose_request& ddd_diagnose_request::operator=(const ddd_diagnose_request& other625) {
  pid = other625.pid;
  __isset = other625.__isset;
  return *this;
}
ddd_diagnose_request& ddd_diagnose_request::operator=(ddd_diagnose_request&& other626) {
...
ddd_node_info::ddd_node_info(const ddd_node_info& other627) {
  node = other627.node;
  drop_time_ms = other627.drop_time_ms;
  is_alive = other627.is_alive;
  is_collected = other627.is_collected;
  ballot = other627.ballot;
  last_committed_decree = other627.last_committed_decree;
  last_prepared_decree = other627.last_prepared_decree;
  __isset = other627.__isset;
}
ddd_node_info::ddd_node_info( ddd_node_info&& other628) {
  node = std::move(other628.node);
  drop_time_ms = std::move(other628.drop_time_ms);
  is_alive = std::move(other628.is_alive);
  is_collected = std::move(other628.is_collected);
  ballot = std::move(other628.ballot);
  last_committed_decree = std::move(other628.last_committed_decree);
  last_prepared_decree = std::move(other628.last_prepared_decree);
  __isset = std::move(other628.__isset);
}
ddd_node_info& ddd_node_info::operator=(const ddd_node_info& other629) {
  node = other629.node;
  drop_time_ms = other629.drop_time_ms;
  is_alive = other629.is_alive;
  is_collected = other629.is_collected;
  ballot = other629.ballot;
  last_committed_decree = other629.last_committed_decree;
  last_prepared_decree = other629.last_prepared_decree;
  __isset = other629.__isset;
  return *this;
}
ddd_node_info& ddd_node_info::operator=(ddd_node_info&& other630) {
  node = std::move(other630.node);
  drop_time_ms = std::move(other630.drop_time_ms);
  is_alive = std::move(other630.is_alive);
  is_collected = std::move(other630.is_collected);
  ballot = std::move(other630.ballot);
  last_committed_decree = std::move(other630.last_committed_decree);
  last_prepared_decree = std::move(other630.last_prepared_decree);
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->dropped.resize(_size631);
            uint32_t _i635;
            for (_i635 = 0; _i635 < _size631; ++_i635)
            {
              xfer += this->dropped[_i635].read(iprot);
            }
            xfer += iprot->readListEnd();
          }
...
uint32_t ddd_partition_info::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("dropped", ::apache::thrift::protocol::T_LIST, 2);
  {
    ...
    std::vector<ddd_node_info> ::const_iterator _iter636;
    for (_iter636 = this->dropped.begin(); _iter636 != this->dropped.end(); ++_iter636)
    {
...
ddd_partition_info::ddd_partition_info(const ddd_partition_info& other637) {
  config = other637.config;
  dropped = other637.dropped;
  reason = other637.reason;
  __isset = other637.__isset;
}
ddd_partition_info::ddd_partition_info( ddd_partition_info&& other638) {
  config = std::move(other638.config);
  dropped = std::move(other638.dropped);
  reason = std::move(other638.reason);
  __isset = std::move(other638.__isset);
}
ddd_partition_info& ddd_partition_info::operator=(const ddd_partition_info& other639) {
  config = other639.config;
  dropped = other639.dropped;
  reason = other639.reason;
  __isset = other639.__isset;
  return *this;
}
ddd_partition_info& ddd_partition_info::operator=(ddd_partition_info&& other640) {
  config = std::move(other640.config);
  dropped = std::move(other640.dropped);
  reason = std::move(other640.reason);
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->partitions.resize(_size641);
            uint32_t _i645;
            for (_i645 = 0; _i645 < _size641; ++_i645)
            {
              xfer += this->partitions[_i645].read(iprot);
            }
            xfer += iprot->readListEnd();
          }
          this->__isset.partitions = true;
...
uint32_t ddd_diagnose_response::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  {
    xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>(this->partitions.size()));
    std::vector<ddd_partition_info> ::const_iterator _iter646;
...
ddd_diagnose_response::ddd_diagnose_response(const ddd_diagnose_response& other647) {
  err = other647.err;
  partitions = other647.partitions;
  __isset = other647.__isset;
}
ddd_diagnose_response::ddd_diagnose_response( ddd_diagnose_response&& other648) {
  err = std::move(other648.err);
  partitions = std::move(other648.partitions);
  __isset = std::move(other648.__isset);
}
ddd_diagnose_response& ddd_diagnose_response::operator=(const ddd_diagnose_response& other649) {
  err = other649.err;
  partitions = other649.partitions;
  __isset = other649.__isset;
  return *this;
}
ddd_diagnose_response& ddd_diagnose_response::operator=(ddd_diagnose_response&& other650) {
  err = std::move(other650.err);
  partitions = std::move(other650.partitions);
...
start_partition_split_request::start_partition_split_request(const start_partition_split_request& other651) {
  app_name = other651.app_name;
  new_partition_count = other651.new_partition_count;
  __isset = other651.__isset;
}
start_partition_split_request::start_partition_split_request( start_partition_split_request&& other652) {
  app_name = std::move(other652.app_name);
  new_partition_count = std::move(other652.new_partition_count);
  __isset = std::move(other652.__isset);
}
start_partition_split_request& start_partition_split_request::operator=(const start_partition_split_request& other653) {
  app_name = other653.app_name;
  new_partition_count = other653.new_partition_count;
  __isset = other653.__isset;
  return *this;
}
start_partition_split_request& start_partition_split_request::operator=(start_partition_split_request&& other654) {
...
start_partition_split_response::start_partition_split_response(const start_partition_split_response& other655) {
  err = other655.err;
  hint_msg = other655.hint_msg;
  __isset = other655.__isset;
}
start_partition_split_response::start_partition_split_response( start_partition_split_response&& other656) {
  err = std::move(other656.err);
  hint_msg = std::move(other656.hint_msg);
  __isset = std::move(other656.__isset);
}
start_partition_split_response& start_partition_split_response::operator=(const start_partition_split_response& other657) {
  err = other657.err;
  hint_msg = other657.hint_msg;
  __isset = other657.__isset;
  return *this;
}
start_partition_split_response& start_partition_split_response::operator=(start_partition_split_response&& other658) {
...
notify_cacth_up_response& notify_cacth_up_response::operator=(const notify_cacth_up_response& other665) {
  err = other665.err;
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->files.resize(_size675);
            uint32_t _i679;
            for (_i679 = 0; _i679 < _size675; ++_i679)
            {
              xfer += this->files[_i679].read(iprot);
            }
            xfer += iprot->readListEnd();
          }
          this->__isset.files = true;
...
uint32_t bulk_load_metadata::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("files", ::apache::thrift::protocol::T_LIST, 1);
  {
    ...
    std::vector<file_meta> ::const_iterator _iter680;
    for (_iter680 = this->files.begin(); _iter680 != this->files.end(); ++_iter680)
    {
...
bulk_load_metadata::bulk_load_metadata(const bulk_load_metadata& other681) {
  files = other681.files;
  file_total_size = other681.file_total_size;
  __isset = other681.__isset;
}
bulk_load_metadata::bulk_load_metadata( bulk_load_metadata&& other682) {
  files = std::move(other682.files);
  file_total_size = std::move(other682.file_total_size);
  __isset = std::move(other682.__isset);
}
bulk_load_metadata& bulk_load_metadata::operator=(const bulk_load_metadata& other683) {
  files = other683.files;
  file_total_size = other683.file_total_size;
  __isset = other683.__isset;
  return *this;
}
bulk_load_metadata& bulk_load_metadata::operator=(bulk_load_metadata&& other684) {
...
start_bulk_load_request::start_bulk_load_request(const start_bulk_load_request& other685) {
  app_name = other685.app_name;
  cluster_name = other685.cluster_name;
  file_provider_type = other685.file_provider_type;
  __isset = other685.__isset;
}
start_bulk_load_request::start_bulk_load_request( start_bulk_load_request&& other686) {
  app_name = std::move(other686.app_name);
  cluster_name = std::move(other686.cluster_name);
  file_provider_type = std::move(other686.file_provider_type);
  __isset = std::move(other686.__isset);
}
start_bulk_load_request& start_bulk_load_request::operator=(const start_bulk_load_request& other687) {
...
start_bulk_load_request& start_bulk_load_request::operator=(start_bulk_load_request&& other688) {
...
start_bulk_load_response::start_bulk_load_response(const start_bulk_load_response& other689) {
  err = other689.err;
  hint_msg = other689.hint_msg;
  __isset = other689.__isset;
}
start_bulk_load_response::start_bulk_load_response( start_bulk_load_response&& other690) {
  err = std::move(other690.err);
  hint_msg = std::move(other690.hint_msg);
  __isset = std::move(other690.__isset);
}
start_bulk_load_response& start_bulk_load_response::operator=(const start_bulk_load_response& other691) {
  err = other691.err;
  hint_msg = other691.hint_msg;
  __isset = other691.__isset;
  return *this;
}
start_bulk_load_response& start_bulk_load_response::operator=(start_bulk_load_response&& other692) {
    ...
    switch (fid)
    {
      ...
      case 3:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->ingest_status = (ingestion_status::type)ecast693;
...
partition_bulk_load_state::partition_bulk_load_state(const partition_bulk_load_state& other694) {
  download_progress = other694.download_progress;
  download_status = other694.download_status;
  ingest_status = other694.ingest_status;
  is_cleaned_up = other694.is_cleaned_up;
  is_paused = other694.is_paused;
  __isset = other694.__isset;
}
partition_bulk_load_state::partition_bulk_load_state( partition_bulk_load_state&& other695) {
  download_progress = std::move(other695.download_progress);
  download_status = std::move(other695.download_status);
  ingest_status = std::move(other695.ingest_status);
  is_cleaned_up = std::move(other695.is_cleaned_up);
  is_paused = std::move(other695.is_paused);
  __isset = std::move(other695.__isset);
}
partition_bulk_load_state& partition_bulk_load_state::operator=(const partition_bulk_load_state& other696) {
...
partition_bulk_load_state& partition_bulk_load_state::operator=(partition_bulk_load_state&& other697) {
    ...
    switch (fid)
    {
      ...
      case 7:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->meta_bulk_load_status = (bulk_load_status::type)ecast698;
...
bulk_load_request::bulk_load_request(const bulk_load_request& other699) {
  pid = other699.pid;
  app_name = other699.app_name;
  primary_addr = other699.primary_addr;
  remote_provider_name = other699.remote_provider_name;
  cluster_name = other699.cluster_name;
  ballot = other699.ballot;
  meta_bulk_load_status = other699.meta_bulk_load_status;
  query_bulk_load_metadata = other699.query_bulk_load_metadata;
  __isset = other699.__isset;
}
bulk_load_request::bulk_load_request( bulk_load_request&& other700) {
  pid = std::move(other700.pid);
  app_name = std::move(other700.app_name);
  primary_addr = std::move(other700.primary_addr);
  remote_provider_name = std::move(other700.remote_provider_name);
  cluster_name = std::move(other700.cluster_name);
  ballot = std::move(other700.ballot);
  meta_bulk_load_status = std::move(other700.meta_bulk_load_status);
  query_bulk_load_metadata = std::move(other700.query_bulk_load_metadata);
  __isset = std::move(other700.__isset);
}
bulk_load_request& bulk_load_request::operator=(const bulk_load_request& other701) {
  pid = other701.pid;
...
bulk_load_request& bulk_load_request::operator=(bulk_load_request&& other702) {
    ...
    switch (fid)
    {
      ...
      case 4:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->primary_bulk_load_status = (bulk_load_status::type)ecast703;
        ...
        if (ftype == ::apache::thrift::protocol::T_MAP) {
          {
            ...
            {
               ::dsn::rpc_address _key709;
              xfer += _key709.read(iprot);
              partition_bulk_load_state& _val710 = this->group_bulk_load_state[_key709];
              xfer += _val710.read(iprot);
            }
            xfer += iprot->readMapEnd();
          }
...
uint32_t bulk_load_response::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("group_bulk_load_state", ::apache::thrift::protocol::T_MAP, 5);
  {
    ...
    std::map< ::dsn::rpc_address, partition_bulk_load_state> ::const_iterator _iter711;
    for (_iter711 = this->group_bulk_load_state.begin(); _iter711 != this->group_bulk_load_state.end(); ++_iter711)
    {
      xfer += _iter711->first.write(oprot);
      xfer += _iter711->second.write(oprot);
    }
    xfer += oprot->writeMapEnd();
  }
  xfer += oprot->writeFieldEnd();
...
bulk_load_response::bulk_load_response(const bulk_load_response& other712) {
  err = other712.err;
  pid = other712.pid;
  app_name = other712.app_name;
  primary_bulk_load_status = other712.primary_bulk_load_status;
  group_bulk_load_state = other712.group_bulk_load_state;
  metadata = other712.metadata;
  total_download_progress = other712.total_download_progress;
  is_group_ingestion_finished = other712.is_group_ingestion_finished;
  is_group_bulk_load_context_cleaned_up = other712.is_group_bulk_load_context_cleaned_up;
  is_group_bulk_load_paused = other712.is_group_bulk_load_paused;
  __isset = other712.__isset;
}
bulk_load_response::bulk_load_response( bulk_load_response&& other713) {
  err = std::move(other713.err);
  pid = std::move(other713.pid);
  app_name = std::move(other713.app_name);
  primary_bulk_load_status = std::move(other713.primary_bulk_load_status);
  group_bulk_load_state = std::move(other713.group_bulk_load_state);
  metadata = std::move(other713.metadata);
  total_download_progress = std::move(other713.total_download_progress);
  is_group_ingestion_finished = std::move(other713.is_group_ingestion_finished);
  is_group_bulk_load_context_cleaned_up = std::move(other713.is_group_bulk_load_context_cleaned_up);
  is_group_bulk_load_paused = std::move(other713.is_group_bulk_load_paused);
  __isset = std::move(other713.__isset);
}
bulk_load_response& bulk_load_response::operator=(const bulk_load_response& other714) {
  err = other714.err;
  pid = other714.pid;
...
bulk_load_response& bulk_load_response::operator=(bulk_load_response&& other715) {
  ...
  is_group_bulk_load_context_cleaned_up = std::move(other715.is_group_bulk_load_context_cleaned_up);
    ...
    switch (fid)
    {
      ...
      case 6:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->meta_bulk_load_status = (bulk_load_status::type)ecast716;
          this->__isset.meta_bulk_load_status = true;
        } else {
          xfer += iprot->skip(ftype);
        }
...
group_bulk_load_request::group_bulk_load_request(const group_bulk_load_request& other717) {
  app_name = other717.app_name;
  target_address = other717.target_address;
  config = other717.config;
  provider_name = other717.provider_name;
  cluster_name = other717.cluster_name;
  meta_bulk_load_status = other717.meta_bulk_load_status;
  __isset = other717.__isset;
}
group_bulk_load_request::group_bulk_load_request( group_bulk_load_request&& other718) {
  app_name = std::move(other718.app_name);
  target_address = std::move(other718.target_address);
  config = std::move(other718.config);
  provider_name = std::move(other718.provider_name);
...
group_bulk_load_request& group_bulk_load_request::operator=(const group_bulk_load_request& other719) {
...
group_bulk_load_request& group_bulk_load_request::operator=(group_bulk_load_request&& other720) {
    ...
    switch (fid)
    {
      ...
      case 2:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->status = (bulk_load_status::type)ecast721;
          this->__isset.status = true;
        } else {
          xfer += iprot->skip(ftype);
        }
...
group_bulk_load_response::group_bulk_load_response(const group_bulk_load_response& other722) {
  err = other722.err;
  status = other722.status;
  bulk_load_state = other722.bulk_load_state;
  __isset = other722.__isset;
}
group_bulk_load_response::group_bulk_load_response( group_bulk_load_response&& other723) {
  err = std::move(other723.err);
  status = std::move(other723.status);
  bulk_load_state = std::move(other723.bulk_load_state);
  __isset = std::move(other723.__isset);
}
group_bulk_load_response& group_bulk_load_response::operator=(const group_bulk_load_response& other724) {
  err = other724.err;
...
group_bulk_load_response& group_bulk_load_response::operator=(group_bulk_load_response&& other725) {
...
ingestion_request::ingestion_request(const ingestion_request& other726) {
  app_name = other726.app_name;
  metadata = other726.metadata;
  __isset = other726.__isset;
}
ingestion_request::ingestion_request( ingestion_request&& other727) {
  app_name = std::move(other727.app_name);
  metadata = std::move(other727.metadata);
  __isset = std::move(other727.__isset);
}
ingestion_request& ingestion_request::operator=(const ingestion_request& other728) {
  app_name = other728.app_name;
  metadata = other728.metadata;
  __isset = other728.__isset;
  return *this;
}
ingestion_request& ingestion_request::operator=(ingestion_request&& other729) {
...
ingestion_response::ingestion_response(const ingestion_response& other730) {
  err = other730.err;
  rocksdb_error = other730.rocksdb_error;
  __isset = other730.__isset;
}
ingestion_response::ingestion_response( ingestion_response&& other731) {
  err = std::move(other731.err);
  rocksdb_error = std::move(other731.rocksdb_error);
  __isset = std::move(other731.__isset);
}
ingestion_response& ingestion_response::operator=(const ingestion_response& other732) {
  err = other732.err;
  rocksdb_error = other732.rocksdb_error;
  __isset = other732.__isset;
  return *this;
}
ingestion_response& ingestion_response::operator=(ingestion_response&& other733) {
    ...
    switch (fid)
    {
      ...
      case 2:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->type = (bulk_load_control_type::type)ecast734;
          this->__isset.type = true;
        } else {
          xfer += iprot->skip(ftype);
        }
...
control_bulk_load_request::control_bulk_load_request(const control_bulk_load_request& other735) {
  app_name = other735.app_name;
  type = other735.type;
  __isset = other735.__isset;
}
control_bulk_load_request::control_bulk_load_request( control_bulk_load_request&& other736) {
  app_name = std::move(other736.app_name);
  type = std::move(other736.type);
  __isset = std::move(other736.__isset);
}
control_bulk_load_request& control_bulk_load_request::operator=(const control_bulk_load_request& other737) {
  app_name = other737.app_name;
  type = other737.type;
  __isset = other737.__isset;
  return *this;
}
control_bulk_load_request& control_bulk_load_request::operator=(control_bulk_load_request&& other738) {
...
control_bulk_load_response::control_bulk_load_response(const control_bulk_load_response& other739) {
  err = other739.err;
  hint_msg = other739.hint_msg;
  __isset = other739.__isset;
}
control_bulk_load_response::control_bulk_load_response( control_bulk_load_response&& other740) {
  err = std::move(other740.err);
  hint_msg = std::move(other740.hint_msg);
  __isset = std::move(other740.__isset);
}
control_bulk_load_response& control_bulk_load_response::operator=(const control_bulk_load_response& other741) {
  err = other741.err;
  hint_msg = other741.hint_msg;
  __isset = other741.__isset;
  return *this;
}
control_bulk_load_response& control_bulk_load_response::operator=(control_bulk_load_response&& other742) {
...
query_bulk_load_request::query_bulk_load_request(const query_bulk_load_request& other743) {
  app_name = other743.app_name;
  __isset = other743.__isset;
}
query_bulk_load_request::query_bulk_load_request( query_bulk_load_request&& other744) {
  app_name = std::move(other744.app_name);
  __isset = std::move(other744.__isset);
}
query_bulk_load_request& query_bulk_load_request::operator=(const query_bulk_load_request& other745) {
  app_name = other745.app_name;
  __isset = other745.__isset;
  return *this;
}
query_bulk_load_request& query_bulk_load_request::operator=(query_bulk_load_request&& other746) {
    ...
    switch (fid)
    {
      ...
      case 3:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->app_status = (bulk_load_status::type)ecast747;
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->partitions_status.resize(_size748);
            uint32_t _i752;
            for (_i752 = 0; _i752 < _size748; ++_i752)
            {
              int32_t ecast753;
              xfer += iprot->readI32(ecast753);
              this->partitions_status[_i752] = (bulk_load_status::type)ecast753;
            }
            xfer += iprot->readListEnd();
          }
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->bulk_load_states.resize(_size754);
            uint32_t _i758;
            for (_i758 = 0; _i758 < _size754; ++_i758)
            {
              {
                this->bulk_load_states[_i758].clear();
                uint32_t _size759;
                ...
                {
                   ::dsn::rpc_address _key764;
                  xfer += _key764.read(iprot);
                  partition_bulk_load_state& _val765 = this->bulk_load_states[_i758][_key764];
                  xfer += _val765.read(iprot);
                }
                xfer += iprot->readMapEnd();
              }
            }
...
uint32_t query_bulk_load_response::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("partitions_status", ::apache::thrift::protocol::T_LIST, 4);
  {
    ...
    std::vector<bulk_load_status::type> ::const_iterator _iter766;
    for (_iter766 = this->partitions_status.begin(); _iter766 != this->partitions_status.end(); ++_iter766)
    {
      xfer += oprot->writeI32((int32_t)(*_iter766));
    }
    xfer += oprot->writeListEnd();
  }
  xfer += oprot->writeFieldEnd();
  ...
  xfer += oprot->writeFieldBegin("bulk_load_states", ::apache::thrift::protocol::T_LIST, 6);
  {
    ...
    std::vector<std::map< ::dsn::rpc_address, partition_bulk_load_state> > ::const_iterator _iter767;
    for (_iter767 = this->bulk_load_states.begin(); _iter767 != this->bulk_load_states.end(); ++_iter767)
    {
      {
        xfer += oprot->writeMapBegin(::apache::thrift::protocol::T_STRUCT, ::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>((*_iter767).size()));
        std::map< ::dsn::rpc_address, partition_bulk_load_state> ::const_iterator _iter768;
        for (_iter768 = (*_iter767).begin(); _iter768 != (*_iter767).end(); ++_iter768)
        {
          xfer += _iter768->first.write(oprot);
          xfer += _iter768->second.write(oprot);
        }
        xfer += oprot->writeMapEnd();
      }
    }
...
query_bulk_load_response::query_bulk_load_response(const query_bulk_load_response& other769) {
  err = other769.err;
  app_name = other769.app_name;
  app_status = other769.app_status;
  partitions_status = other769.partitions_status;
  max_replica_count = other769.max_replica_count;
  bulk_load_states = other769.bulk_load_states;
  hint_msg = other769.hint_msg;
  __isset = other769.__isset;
}
query_bulk_load_response::query_bulk_load_response( query_bulk_load_response&& other770) {
  err = std::move(other770.err);
  app_name = std::move(other770.app_name);
  app_status = std::move(other770.app_status);
  partitions_status = std::move(other770.partitions_status);
  max_replica_count = std::move(other770.max_replica_count);
  bulk_load_states = std::move(other770.bulk_load_states);
  hint_msg = std::move(other770.hint_msg);
  __isset = std::move(other770.__isset);
}
query_bulk_load_response& query_bulk_load_response::operator=(const query_bulk_load_response& other771) {
  err = other771.err;
...
query_bulk_load_response& query_bulk_load_response::operator=(query_bulk_load_response&& other772) {
    ...
    switch (fid)
    {
      case 1:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->type = (hotkey_type::type)ecast773;
          this->__isset.type = true;
        } else {
          xfer += iprot->skip(ftype);
        }
      ...
      case 2:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->action = (detect_action::type)ecast774;
...
detect_hotkey_request::detect_hotkey_request(const detect_hotkey_request& other775) {
  type = other775.type;
  action = other775.action;
  pid = other775.pid;
  __isset = other775.__isset;
}
detect_hotkey_request::detect_hotkey_request( detect_hotkey_request&& other776) {
  type = std::move(other776.type);
  action = std::move(other776.action);
  pid = std::move(other776.pid);
  __isset = std::move(other776.__isset);
}
detect_hotkey_request& detect_hotkey_request::operator=(const detect_hotkey_request& other777) {
  type = other777.type;
...
detect_hotkey_request& detect_hotkey_request::operator=(detect_hotkey_request&& other778) {
...
detect_hotkey_response::detect_hotkey_response(const detect_hotkey_response& other779) {
  err = other779.err;
  err_hint = other779.err_hint;
  __isset = other779.__isset;
}
detect_hotkey_response::detect_hotkey_response( detect_hotkey_response&& other780) {
  err = std::move(other780.err);
  err_hint = std::move(other780.err_hint);
  __isset = std::move(other780.__isset);
}
detect_hotkey_response& detect_hotkey_response::operator=(const detect_hotkey_response& other781) {
  err = other781.err;
  err_hint = other781.err_hint;
  __isset = other781.__isset;
  return *this;
}
detect_hotkey_response& detect_hotkey_response::operator=(detect_hotkey_response&& other782) {
